...
INSERT IGNORE INTO categories (name, name_fa, slug, description_fa) VALUES
...
-- Insert default subcategories (only if not exists)
INSERT IGNORE INTO subcategories (category_id, name, name_fa, slug, description_fa) VALUES
...
-- Insert default pages (only if not exists)
INSERT IGNORE INTO pages (title, title_fa, slug, content_fa, page_type) VALUES
